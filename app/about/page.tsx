    ...
    <main>
      <section style={{ padding: '80px 0 64px' }}>
        <div className="w" style={{ maxWidth: 760 }}>
          ...
          <h1 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 48, fontWeight: 300, lineHeight: 1.15, letterSpacing: '-.02em', marginBottom: 48 }}>
          ...
          <div className="sg">
            ...
            <div className="sb"><div className="sn">14</div><div className="sl">Peptides</div></div>
